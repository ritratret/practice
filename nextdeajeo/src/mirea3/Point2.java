...
public class Point2 { // 포인터. 각도에 따른 길이
	public double x;
	public double y;
	...
	public double distanTo(Point2 po) { // 포인터로 들어온 값과의 차로 거리를 구함. 두 점 간의 거리
	...
	public double theta() {// 세타 - 원점과 이어진 직선의 안쪽 각도
		double radian_result = Math.atan2(x, y); // 투 선의 내각
		return Math.toDegrees(radian_result); // toDegrees:라디안을 각도로 바꿔줌. 사람이 인식할 수 있는 각도
	}
